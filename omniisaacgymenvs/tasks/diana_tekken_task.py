...
class DianaTekkenTask(RLTask):
    ...
    def post_reset(self):
        ...
        # 0.2782, -0.3680, -0.3825,  2.2931,  2.8813, -0.3066,  1.6716
        self.default_dof_pos = torch.tensor([0.2907, -0.4830, -0.3727,  2.2539,  2.8464, -0.0673,  1.7076]  + [0.] * 20, device=self._device)
